...
describe("OrchestrationReactor", () => {
  ...
  it("starts provider ingestion, provider command, checkpoint, thread deletion, and merge cleanup reactors", async () => {
      ...
      Layer.effect(OrchestrationReactor, makeOrchestrationReactor).pipe(
        ...
        Layer.provideMerge(
          Layer.succeed(MergeCleanupReactor, {
            start: () => {
              started.push("merge-cleanup-reactor");
              return Effect.void;
            },
            drain: Effect.void,
          }),
