import {
  ...
  ThreadTurnCancelRequestedPayload as ContractsThreadTurnCancelRequestedPayloadSchema,
...
export const ThreadTurnCancelRequestedPayload = ContractsThreadTurnCancelRequestedPayloadSchema;
