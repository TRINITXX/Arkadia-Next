...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.subscribeProjectMemory]: AuthOrchestrationReadScope,
  [WS_METHODS.projectMemoryPin]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectMemoryDelete]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.subscribeRecentFiles]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.gitMergeCleanupThread]: AuthOrchestrationOperateScope,
