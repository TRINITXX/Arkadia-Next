...
import { AGENT_FONT_OPTIONS } from "../../lib/appFonts";
...
export function useSettingsRestore(onRestored?: () => void) {
  ...
  const changedSettingLabels = useMemo(
    ...
    [
      ...
      settings.environmentIdentificationMode,
      settings.contentPaletteId,
      settings.chromeBackgroundId,
      settings.agentFontFamily,
  ...
  const restoreDefaults = useCallback(async () => {
    ...
    updateSettings({
      ...
      customContentPalette: DEFAULT_UNIFIED_SETTINGS.customContentPalette,
...
function TerminalFontRow() {
  ...
  return (
    <FontFamilySettingsRow
      ...
      onValueChange={(terminalFontFamily) => updateSettings({ terminalFontFamily })}
      requireMonospace
      size={{
      ...
      preview={
        <TerminalFontPreview
          family={resolveTerminalFontPreference({
            ...
            terminal: settings.terminalFontFamily,
          })}
...
/**
 * The compact view keeps upstream's shared interface/code controls while
 * leaving Arkadia's terminal preference independent.
 */
