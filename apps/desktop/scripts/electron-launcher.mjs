// This file mostly exists because we want dev mode to say "Arkadia (Dev)" instead of "electron"
...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "Arkadia (Dev)" : "Arkadia";
export const APP_BUNDLE_ID = isDevelopment
  ? `com.trinitxx.arkadia.dev.${devBundleIdSuffix || "local"}`
  : "com.trinitxx.arkadia";
