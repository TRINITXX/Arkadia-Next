...
| Kimi       | [Claude Code](https://claude.com/product/claude-code) | `claude`       | API key in Settings   |
...
For provider-specific setup, see [Codex](./providers-codex.md), [Claude](./providers-claude.md), and [Kimi](./providers-kimi.md).
