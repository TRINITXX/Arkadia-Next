...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // Show the compact corner popup (desktop only) when an agent finishes, needs
  // input, or errors while the app is in the background. On by default.
  desktopNotifications: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  desktopNotifications: Schema.optionalKey(Schema.Boolean),
