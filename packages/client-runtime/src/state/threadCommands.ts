...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    cancelTurn: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:cancel-turn",
      execute: (input: CancelThreadTurnInput) => cancelThreadTurn(input),
      scheduler,
      concurrency,
    }),
